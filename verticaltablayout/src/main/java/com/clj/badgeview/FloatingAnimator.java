...
import com.clj.badgeview.CLJFloatView;

import java.lang.ref.WeakReference;
import java.util.Random;

public class FloatingAnimator extends ValueAnimator {
    private BitmapFragment[][] mFragments;
    private WeakReference<CLJFloatView> mWeakBadge;

    public FloatingAnimator(Bitmap badgeBitmap, PointF center, CLJFloatView badge) {
        ...
        addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                CLJFloatView badgeView = mWeakBadge.get();
